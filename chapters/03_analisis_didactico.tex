...
\begin{table}[H]
	\begin{tabular}{|c|l|l|l|l|}
		\hline
		\multicolumn{5}{|c|}{\textbf{RÚBRICA 1: PRUEBAS ESCRITAS}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \\ \hline
		\textbf{Indicadores/ Comp. Clave}                                                                                   & \multicolumn{1}{c|}{\textbf{Puntuación}} & \multicolumn{1}{c|}{\textbf{Avanzado}}                                                                                                & \multicolumn{1}{c|}{\textbf{Intermedio}}                                                                                              & \multicolumn{1}{c|}{\textbf{Básico}}                                                                                                                \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Identificación y\\ presentación de datos\\ CCL, CMCT, CAA, SIE\end{tabular}}     & 30\%                                     & \begin{tabular}[c]{@{}l@{}}El ejercicio escrito presenta una\\ excelente presentación en cuanto a\\ limpieza y claridad.\end{tabular} & \begin{tabular}[c]{@{}l@{}}El ejercicio escrito tiene \\ una presentación poco correcta en\\ cuanto limpieza y claridad.\end{tabular} & \begin{tabular}[c]{@{}l@{}}El ejercicio escrito posee una \\ incorrecta presentación en cuanto a\\ limpieza y claridad.\end{tabular}                \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Justificación y\\ resolución del\\ problema.\\ CCL, CMCT, CAA, SIE\end{tabular}} & 70\%                                     & \begin{tabular}[c]{@{}l@{}}El razonamiento del ejercicio es\\ correcto y los cálculos son exactos.\end{tabular}                       & \begin{tabular}[c]{@{}l@{}}El razonamiento no es totalmente \\ correcto o existen errores en los\\ cálculos.\end{tabular}             & \begin{tabular}[c]{@{}l@{}}No tiene lógica el razonamiento o no\\ existe. Los cálculos son totalmente\\ incorrectos o están en blanco.\end{tabular} \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	\begin{tabular}{|c|c|l|l|l|}
		\hline
		\multicolumn{5}{|c|}{\textbf{RÚBRICA 2: ANÁLISIS DEL TRABAJO REALIZADO}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Indicadores / \\ Comp. Clave\end{tabular}}                         & \textbf{Puntuación} & \multicolumn{1}{c|}{\textbf{Avanzado}}                                                                                                                                                                                            & \multicolumn{1}{c|}{\textbf{Intermedio}}                                                                                                                                                                                                                  & \multicolumn{1}{c|}{\textbf{Básico}}                                                                                                                                                                                                              \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Presentación\\ CMCT, CD, \\ CAA, SIE\end{tabular}}                 & 30\%                & \begin{tabular}[c]{@{}l@{}}El cuaderno del alumno posee una\\ excelente presentación en cuanto a \\ limpieza y claridad. Está ordenado de \\ manera temporal. 30\%\end{tabular}                                                   & \begin{tabular}[c]{@{}l@{}}El cuaderno del alumno posee una\\ presentación poco correcta en cuanto\\ a limpieza y claridad. Hay pocas partes \\ en el cuaderno desordenadas. 15\%\end{tabular}                                                            & \begin{tabular}[c]{@{}l@{}}El cuaderno del alumno presenta una\\ incorrecta presentación en cuanto a \\ limpieza y claridad. Está totalmente\\ desordenado. 5\%\end{tabular}                                                                      \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Contenidos\\ CCL, CMCT, \\ CD, CAA, SIE\end{tabular}}              & 30\%                & \begin{tabular}[c]{@{}l@{}}El cuaderno presenta todo el contenido\\ aprendido en clase, con notas de\\ aclaraciones hechas en clase, todos los\\ ejercicios y tareas. 30\%\end{tabular}                                           & \begin{tabular}[c]{@{}l@{}}En el cuaderno falta información\\ del contenido aprendido en clase,\\ aunque se toma nota de las aclaraciones\\ hechas en clase y faltan muy pocos\\ ejercicios o tareas. 15\%\end{tabular}                                   & \begin{tabular}[c]{@{}l@{}}En el cuaderno hay muy poca \\ información del contenido aprendido\\ en clase, no se toma nota de las\\ aclaraciones hechas en clase, faltan\\ numerosos ejercicios y tareas. 5\%\end{tabular}                         \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Correcciones/Ortografía\\ CCL, CMCT, \\ CD, CAA, SIE\end{tabular}} & 40\%                & \begin{tabular}[c]{@{}l@{}}Los errores están bien señalados y\\ corregidos. No suele volver a repetirlos.\\ Se expresa correctamente, cuidando la\\ caligrafía. Cuando sale a la pizarra\\ explica lo que hace. 40\%\end{tabular} & \begin{tabular}[c]{@{}l@{}}A veces se señalan y corrigen los\\ errores, pocas veces se vuelven a repetir.\\ Expresión correcta pero con algunas faltas\\ ortográficas.\\ Cuando sale a la pizarra no explica lo\\ que hace, sólo copia. 20\%\end{tabular} & \begin{tabular}[c]{@{}l@{}}No se señalan o corrigen los errores y\\ vuelve a cometerlos una y otra vez..\\ Expresión en algunos casos\\ incomprensible y fallos ortográficos.\\ No explica nada o no sale nunca a la\\ pizarra. 10\%\end{tabular} \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	\begin{tabular}{|c|c|l|l|l|}
		\hline
		\multicolumn{5}{|c|}{\textbf{RÚBRICA 3: ANÁLISIS DE TAREAS, TRABAJOS (TIC) O GRUPAL PROPUESTOS}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Indicadores / \\ Comp. Clave\end{tabular}}                                                                     & \textbf{Puntuación} & \multicolumn{1}{c|}{\textbf{Avanzado}}                                                                                                                                                                                                                                    & \multicolumn{1}{c|}{\textbf{Intermedio}}                                                                                                                                                                                                                                                  & \multicolumn{1}{c|}{\textbf{Básico}}                                                                                                                                                                                                  \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Aprendizajes\\ previos\\ CCL, CMCT\end{tabular}}                                                               & 20\%                & \begin{tabular}[c]{@{}l@{}}Siempre relaciona sus conocimientos previos,\\ costruye y reflexiona su proceso de\\ aprendizaje.  20\%\end{tabular}                                                                                                                           & \begin{tabular}[c]{@{}l@{}}Casi siempre relaciona sus conocimientos\\ previos, construye y reflexiona su proceso\\ de aprendizaje. 10\%\end{tabular}                                                                                                                                      & \begin{tabular}[c]{@{}l@{}}Casi nunca relaciona sus conocimientos\\ previos, construye y reflexiona su proceso\\ de aprendizaje. 5\%\end{tabular}                                                                                     \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Participación\\ CCL, CAA,\\ SIE, CSC\end{tabular}}                                                             & 20\%                & \begin{tabular}[c]{@{}l@{}}Siempre ha participado muy activamente\\ aportando ideas, haciendo observaciones muy\\ interesantes hasta conseguir óptimos resultados.\\ Siempre ha aceptado críticas y sugerencias. En\\ trabajos grupales actúa de líder. 20\%\end{tabular} & \begin{tabular}[c]{@{}l@{}}Casi siempre ha participado activamente\\ aportando ideas, haciendo observaciones\\ interesantes hasta conseguir óptimos \\ resultados. Realiza algunas de las tareas y\\ proyectos que se le proponen. En trabajos\\ grupales trabaja bien. 10\%\end{tabular} & \begin{tabular}[c]{@{}l@{}}Casi nunca participa aportando ideas ni hace\\ observaciones interesantes. No realiza casi\\ ninguna tarea y proyecto propuesto. En \\ trabajos grupales se deja llevar por los \\ demás. 5\%\end{tabular} \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Uso de recursos\\ CCL, CD, \\ CAA, SIE\end{tabular}}                                                           & 20\%                & \begin{tabular}[c]{@{}l@{}}Sabe buscar y utiliza los recursos e información\\ que necesita para realizar sus tareas. 20\%\end{tabular}                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}Casi siempre sabe buscar los recursos e\\ información que necesita para realizar\\ sus tareas o trabajos. 10\%\end{tabular}                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}Casi nunca sabe buscar los recursos e \\ información que necesita para realizar\\ sus tareas o trabajos. 5\%\end{tabular}                                                                                  \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Realización de tareas\\ y proyectos\\ CCL, CMCT, CD, \\ CAA, SIE\end{tabular}}                                 & 20\%                & \begin{tabular}[c]{@{}l@{}}Siempre realiza las tareas y proyectos que se le\\ proponen. Utiliza distintas técnicas y/o\\ estrategias matemáticas para la realización de \\ sus trabajos. Los contenidos y recursos\\ utilizados son adecuados. 20\%\end{tabular}          & \begin{tabular}[c]{@{}l@{}}Casi siempre realiza las tareas y proyectos\\ que se le proponen.. A veces utiliza \\ distintas técnicas matemáticas para la \\ realización de sus trabajos. Los contenidos\\ y recursos utilizados no son del todo\\ adecuados. 10\%\end{tabular}             & \begin{tabular}[c]{@{}l@{}}Casi nunca realiza las tareas ni proyectos\\ que se le proponen, y si lo hace no utiliza\\ distintas técnicas matemáticas. 5\%\end{tabular}                                                                \\ \hline
		\textbf{\begin{tabular}[c]{@{}c@{}}Explicación de la\\ tarea/proyecto en el papel\\ y/o en la pizarra\\ CCL, CMCT, CAA, \\ SIE, CSC\end{tabular}} & 20\%                & \begin{tabular}[c]{@{}l@{}}Siempre explica lo que hace en sus tareas, así\\ como en las pizarra. Entrega a tiempo su \\ trabajo. 20\%\end{tabular}                                                                                                                        & \begin{tabular}[c]{@{}l@{}}Casi siempre explica lo que hace en sus\\ tareas o en la pizarra. A veces no entrega\\ a tiempo el trabajo. 10\%\end{tabular}                                                                                                                                  & \begin{tabular}[c]{@{}l@{}}Casi nunca explica lo que hace ni en los \\ trabajos ni en la pizarra. No entrega el \\ trabajo. 5\%\end{tabular}                                                                                          \\ \hline
	\end{tabular}
\end{table}
\end{document}
