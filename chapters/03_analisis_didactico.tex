...
\begin{itemize}
	...
	\item \textbf{O5.} Operar con números complejos: suma, resta, multiplicación y potencia.
	\item \textbf{O6.} Obtener soluciones complejas e ecuaciones de segundo grado con coeficientes reales.
...
\begin{table}[H]
	...
	\begin{tabular}{lcccccccc}
		\hline
		\toprule
		\textbf{Objetivos específicos} & \textbf{RA} & \textbf{C} & \textbf{M} & \textbf{RP} & \textbf{R} & \textbf{LS} & \textbf{HM} \\ \hline
		\midrule
		O1                             & X           & X          & X          &             & X          & X           &             \\ \hline
		O2                             &             & X          & X          &             & X          & X           &             \\ \hline
		O3                             & X           &            & X          & X           &            & X           & X           \\ \hline
		O4                             &             & X          & X          & X           & X          & X           & X           \\ \hline
		O5                             & X           &            & X          & X           &            & X           & X           \\ \hline
